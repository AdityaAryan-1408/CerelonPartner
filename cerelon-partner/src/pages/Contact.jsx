            ...
            <div className="space-y-8">
              ...
              <div className="flex items-center group">
                ...
                <div>
                  ...
                  <p className="font-bold text-slate-900 dark:text-white">+91 [Number]</p>
                </div>
              </div>
              <div className="pt-8">
                <a href="https://wa.me/#" className="bg-emerald-600 hover:bg-emerald-700 text-white px-8 py-4 font-black uppercase tracking-widest text-xs flex items-center justify-center w-full sm:w-auto transition-colors">
              ...
              {sent ? (
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                  ...
                  <div className="space-y-2">
                    ...
                    <select className={`${inputClasses} font-bold text-sm uppercase`}>
                  ...
                  <div className="space-y-2">
                    ...
                    <textarea className={`${inputClasses} h-32 resize-none`} placeholder="Growth objectives..."></textarea>
                  </div>
                  <button type="submit" className="w-full bg-slate-950 dark:bg-emerald-600 text-white font-black py-4 uppercase tracking-[0.2em] text-sm hover:bg-emerald-600 dark:hover:bg-emerald-500 transition-colors">
                    Submit Inquiry
                  </button>
                </form>
              )}
