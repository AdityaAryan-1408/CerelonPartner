...
const About = () => {
  return (
    <div className="pt-32 pb-24 animate-in slide-in-from-bottom-4 duration-700 bg-white dark:bg-slate-950">
      <div className="max-w-7xl mx-auto px-6 lg:px-8">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16">
          <div>
            <h1 className="text-5xl font-black tracking-tighter uppercase mb-8 text-slate-950 dark:text-white">About Cerelon</h1>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            <div className="p-8 bg-slate-50 dark:bg-slate-900 flex flex-col justify-end">
              <div className="text-emerald-600 dark:text-emerald-500 font-black text-4xl mb-4 tracking-tighter">100%</div>
              <p className="text-xs uppercase font-bold tracking-widest text-slate-400">Process Driven</p>
            </div>
            
            <div className="p-8 bg-slate-900 dark:bg-black text-white flex flex-col justify-end">
            ...
            <div className="p-8 bg-slate-50 dark:bg-slate-900 flex flex-col justify-end">
               <Globe className="w-8 h-8 text-emerald-600 dark:text-emerald-500 mb-4" />
